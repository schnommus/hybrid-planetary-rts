...
g++ -O3 -std=c++11 -I../thirdparty/include -L../thirdparty/lib ../thirdparty/gamemath/gamemath.o ../thirdparty/tinyxml2.cpp ../src/Main.cpp ../src/EntityFactory.cpp ../src/LevelEditor.cpp ../src/MinimapSystem.cpp ../src/Components.cpp ../src/CameraSystem.cpp ../src/RenderSystem.cpp ../src/DebugSystems.cpp -lArtemisCpp -lsfml-graphics -lsfml-window -lsfml-system -o ../bin/GamePrototype.out
