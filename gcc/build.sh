...
g++ -std=c++11 -I../thirdparty/include -L../thirdparty/lib ../thirdparty/gamemath/gamemath.o ../src/Main.cpp ../src/LevelEditor.cpp ../src/MinimapSystem.cpp ../src/Components.cpp ../src/CameraSystem.cpp ../src/RenderSystem.cpp ../src/DebugSystems.cpp -lArtemisCpp -lsfml-graphics -lsfml-window -lsfml-system -o ../bin/GamePrototype.out
